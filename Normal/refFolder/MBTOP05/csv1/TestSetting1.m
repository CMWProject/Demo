...
try
    ...
    cd('C:\Users\user4.gaio\Desktop\Normal\resFolder\MBTOP05\csv1');
    load_system('C:\Users\user4.gaio\Desktop\Normal\resFolder\MBTOP05\csv1\tarmodel');
...
% 入力データ
cmwOption.data{1} = timeseries(uint8(MBTOP.OP5.castStrToNum([{'1';'2';'3';}], 'uint8')), cmwOption.time);
